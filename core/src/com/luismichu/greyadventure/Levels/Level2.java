...
public class Level2 extends Level {
    ...
    public static Level2 create(MyAssetManager assetManager, MyPreferenceManager preferenceManager, MyPhysicManager physicManager,
                                OrthographicCamera camera, OrthographicCamera cameraUI, GameState gameState){
        level2 = new Level2(assetManager, preferenceManager, physicManager, camera, cameraUI, gameState);
        return getInstance();
    }
    ...
    private Level2(MyAssetManager assetManager, MyPreferenceManager preferenceManager, MyPhysicManager physicManager,
                   OrthographicCamera camera, OrthographicCamera cameraUI, GameState gameState){
        super(assetManager, preferenceManager, physicManager, camera, cameraUI, gameState);

        assetManager.addToQueue(MyAssetManager.AssetDescriptors.map2);
        assetManager.addToQueue(MyAssetManager.AssetDescriptors.enemyGreenAttack);
        assetManager.addToQueue(MyAssetManager.AssetDescriptors.deathPlayerSound);
        assetManager.addToQueue(MyAssetManager.AssetDescriptors.musicLevel2);
        ...
        map = (TiledMap) assetManager.get(MyAssetManager.AssetDescriptors.map2);
        ...
        createEnemies(assetManager.getTextures(MyAssetManager.AssetDescriptors.enemyGreenAttack));
        createDialogs();
        
        deathPlayerSound = assetManager.getSounds(MyAssetManager.AssetDescriptors.deathPlayerSound);

        music = assetManager.getMusic(MyAssetManager.AssetDescriptors.musicLevel2);
